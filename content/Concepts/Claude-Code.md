# Claude Code
> 관련 노트: 216개 | 마지막 갱신: 2026-09-08 20:46

## 개요

주요 키워드: **Claude** · **AI** · **Code** · **코드** · **소개합니다** · **다양한** · **클로드** · **방법을**
...
| 노트 | 저자 · 날짜 | 요약 |
|------|-------------|------|
| [[u260908_code4_social_claude-mem은-대화_ad97a9]] | `@code4_social` · 26-09-08 | claude-mem은 대화 내용을 저장하여 작업의 맥락을 유지하는 도구입니다. 이를 통해 개발자들은 이전 대화에서 확립한 결정이나 규칙을 쉽게 찾아볼 수 있습니다. 특히 Claude Code 사용자를 위해 최적화된 도구로, 작업 흐름의 연속성을 지원합니다. |
